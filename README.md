...
- **Adjust life.** Tap the left third of your area for −1, the right third for +1 (committed on lift, with a light haptic). A dim − and + flank your life total — minus on your left, plus on your right — to label which side does what. Tap as fast as you like — rapid taps skip the staggered roll so the number keeps pace with your finger. Hold a side past ~0.5s to repeat in steps of 10 with a medium haptic per tick.
